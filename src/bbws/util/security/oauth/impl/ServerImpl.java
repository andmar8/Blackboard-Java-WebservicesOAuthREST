/*
    Blackboard Webservices OAuth REST Implementation
...
//
//    public boolean isRequestValid(long requestTimeout,String requestMethod,String resource,OAuthParameters requestParams)
//    {
//        //check nonce
...
//        long timestamp = Long.parseLong(requestParams.getTimestamp());
...
//        try
//        {
//            //return isSignatureValid(requestMethod,this.baseuri+resource,this.consumer_key,this.consumer_secret,requestParams.getNonce(),Long.toString(timestamp),requestParams.getSignature());
//            return isSignatureValid(new Request("GET",this.baseuri+resource,requestParams),requestParams,new OAuthSecrets().consumerSecret(this.consumer_secret));
//        }
//        catch(Exception e)
//        {
